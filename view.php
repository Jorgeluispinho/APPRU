...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>RU - Controle de acesso</title>
...
header .opt p {font-family:cursive;text-align: left;font-size:19px;color:#000;}
...
<header >
	...
	<div class="opt">
		<table border="0">
			<tr>
				<td><a href="AddCard.php">Novo usuário
                      <img src="imagens/add.png" style="margin:10px 20px -5px 10px" width="30" title="Add"></a></td>
				<td><p>data de funcionamento:
