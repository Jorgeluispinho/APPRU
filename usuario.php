...
.bod a {float: right;text-decoration: none;font-family:cursive;font-size:25px;color:blue;margin:-40px 0px 0px -20px;padding-right: 100px}
...
<body>
  <header >
    <div class="head">
      ...
      login de Usuários</h1>
    </div>
  </header>

<div class="bod">
   <a href="AddCard.php">Início</a>
    <div class="opt">
        <form  method="POST" >
        	<table>
        		<tr>
...
<?php   
    ...
    if(!empty($Number) && !empty($senha)){

      $u->conectar("nodemculog", "localhost", "root", "");

        if($u->logar($Number, $senha)){

            header("location: AreaPrivada.php");

        }else{
          echo "não consta no banco de dados";
        }
    }
  }
